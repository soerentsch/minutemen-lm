...
import { _error as A, BaseComponentWrapper as de, _warn as te, VanillaFrameworkOverrides as ie, _ALL_GRID_OPTIONS as k, _processOnChange as ae, ModuleRegistry as re, RowApiModule as le, _combineAttributesAndGridOptions as ue, _ALL_EVENTS as se, _getCallbackForEvent as pe, createGrid as fe, ALWAYS_SYNC_GLOBAL_EVENTS as ce } from "ag-grid-community";
class R {
...
const ve = { ref: "root" }, Fe = /* @__PURE__ */ H({
  ...
  setup(r, { expose: d, emit: e }) {
    ...
    }, W = () => Object.create(B().provides);
    return X(() => {
      re.registerModules([le]);
      const a = new ge(B(), W()), u = {
        globalListener: b(),
